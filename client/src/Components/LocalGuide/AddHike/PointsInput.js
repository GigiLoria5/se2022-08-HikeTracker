...
const PointsInput = (props) => {
    ...
    <FormControl sx={{ width: '30ch' }}>
        ...
        <>
            ...
            <TextField variant="outlined" color='primary' label="Longitude"  sx={{ width: '30ch' }} value={pointGPSlon} disabled/> 
        </>
        ) : (
            <Grid></Grid>
        )}
        ...
        <SmootherTextField maxWidth='30ch' label="Description" setText={setPointDescription} required={true} />
